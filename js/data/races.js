...
const TRAIT_DESCRIPTIONS = {
  ...
  "Common": "The universal language of Lyr, spoken by humans and understood across all races. You can speak, read, and write Common.",
  "Sorthen": "The language of the demons, rooted in the aristocratic city of Sorthen. You can speak, read, and write Sorthen.",
  "Sylvan": "The native tongue of the Fae, born from nature itself. You can speak, read, and write Sylvan.",
  "Kiraran": "The language of the Youkai, hailing from the misty isle of Kirara. You can speak, read, and write Kiraran.",
  "Sub-race Dialect": "You can speak, read, and write the dialect of your chosen sub-race.",
  "Language (1 choice)": "You can speak, read, and write one additional language of your choice.",
  "Common Weapon (1)": "You gain proficiency in one common weapon group of your choice.",
